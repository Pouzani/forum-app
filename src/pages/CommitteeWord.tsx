    ...
    return(
        <div>
            <div className="container mx-auto sm:px-6 lg:px-8">
                <h1>MOT DU COMITE <br /> ORGANISATEUR</h1>
                <p className="text-justify">Les élèves ingénieurs des trois prestigieuses écoles, l'INSEA (Institut National de Statistique et d'Économie Appliquée), l'ENSIAS
                ...
                avec des entreprises à la recherche de talents prometteurs dans diverses spécialités d'ingénieurs.
                ...
                nos participants toutes les opportunités possibles pour se faire connaître et se faire remarquer par les entreprises.
